 ...
 * @author jfaja
 */
public class UniversidadGrupo9MeenuVista extends javax.swing.JFrame {

    /**
     * Creates new form UniversidadGrupo9Vista
     */
    public UniversidadGrupo9MeenuVista() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UniversidadGrupo9MeenuVista.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UniversidadGrupo9MeenuVista().setVisible(true);
            }
        });
    }
